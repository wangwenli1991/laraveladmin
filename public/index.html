...
<body class="documenter-project-idea">
	<div id="documenter_sidebar">
		...
		<ul id="documenter_nav">
			<li><a class="current" href="#documenter_cover">项目简介</a></li>
			<li><a href="#update" title="Html Structure">项目功能</a></li>
			<li><a href="#files_structure" title="Files Structure"></a></li>
			<li><a href="#html_structure" title="Html Structure">Html Structure</a></li>
			<li><a href="#css_structure" title="CSS Structure">CSS Structure</a></li>
			<li><a href="#javascript" title="Javascript">Javascript</a></li>
			<li><a href="#rtl" title="RTL support">RTL support</a></li>
			...
			<li><a href="#contact_form" title="PHP Scripts">Contact form without Google reCAPTCHA</a></li>
			<li><a href="#contact_form_recaptcha" title="Google reCAPTCHA">Contact form with Google reCAPTCHA</a></li>
		...
		<div id="documenter_copyright">Copyright HtmlCoder 2017<br>
		made with the <a href="http://rxa.li/documenter">Documenter v2.0</a> 
		</div>
	</div>
	<div id="documenter_content">
	<section id="documenter_cover">
	<h1>The Project - 1.4.0</h1>
	...
	<hr>
	<ul>
	<li>created: 08/05/2015</li>
	<li>latest update: 12/21/2016</li>
	<li>by: HtmlCoder</li>
	<li><a href=""></a></li>
	...
	<section id="update">
	<div class="page-header"><h3>Update from version 1.3.0 to 1.4.0</h3><hr class="notop"></div>

	<h4>The version 1.4.0 includes:</h4>
	<ul>
		<li>2 New Home Pages</li>
		<li>RTL support</li>
		<li>Several improvements</li>
		<li>Several plugin updates</li>
		<li>Fixes</li>
		<li>See detailed <a href="../../html/template/changelog.txt">Changelog</a></li>
	</ul>
	<p style="font-size:16px;"><strong>Important Notice: </strong>Before the update, please backup all your files and your website. It is recommended to update email-sender.php and email-sender-recaptcha.php files.</p>
...
<ol>
	...
	<li>images folder (new image placeholders added)</li>
	<li>js/template.js file</li>
	<li>less folder</li>
	<li>sass folder</li>
	<li>php folder</li>
	<li>All HTML files</li>
	<li><strong>plugins</strong> folder:
		<ul>
			<li>Updated jquery to v.2.4.4</li>
			<li>Updated slider revolution to v5.3.1.6</li>
			<li>Updated owl carousel to v2.2.0</li>
			<li>Updated Bootstrap Notify to v3.1.3</li>
			<li>Updated Charts.js to v2.4.0</li>
			<li>Updated fullpage.js to v2.9.0</li>
			<li>Updated hover.css to v2.1.0</li>
			<li>Updated isotope to v3.0.1</li>
			<li>Updated jquery.contdown.js to v2.1.0</li>
			<li>Updated vide.js to v0.5.1</li>
			<li>Updated waypoints to version 4.0.1</li>
			<li>Updated jquery.browser.js to version 0.1.0</li>
			<li>Updated jquery.validate.js to latest release v1.16.0</li>
			<li>Updated animated.css to version 3.5.1</li>
			<li>Removed slider revolution version 4 files from template</li>
			<li>Removed owl carousel version 1 files from template</li>
		</ul>
	</li>
</ol>
...
New HTML files:
<ol>
	<li><a target="_blank" href="../../html/template/index-rtl.html">index-rtl.html</a> (RTL Home Page)</li>
	<li><a target="_blank" href="../../html/template/index-portfolio-2.html">index-portfolio-2.html</a> (Portfolio 2 Home Page)</li>
</ol>
...
<p>
	...
	- - less&nbsp; (All the less files of the Project's template)<br>
	- - sass&nbsp; (All the sass files of the Project's template)<br>
...
<div>
	<ul>
		...
		<li>css/typography-default.css (This stylesheet contains the default typography scheme of the template, see <a href="#typography">Typography</a> section)</li>
		<li>css/typography-scheme-2.css (This stylesheet contains an alternative typography scheme, see <a href="#typography">Typography</a> section)</li>
		<li>css/print-invoice.css (This stylesheet contains all the print css rules for invoice)</li>
...
<section id="rtl">
	<div class="page-header"><h3>RTL support</h3><hr class="notop"></div>
	<p>In websites with <strong>right-to-left</strong> text direction, use the following CSS files in the head section of your HTML file: </p>
	<ul>
		<li>css/rtl_style.css</li>
		<li>css/rtl_typography-default.css</li>
	</ul>
	<p>instead of css/style.css and css/typography-default.css.</p>
	<p>Every HTML file in the template can be used in websites with <strong>right-to-left</strong> text direction, by replacing the <strong>style.css</strong> with <strong>rtl_style.css</strong> file and <strong>typography-default.css</strong> with <strong>rtl_typography-default.css</strong> file, in the head section.</p>
	<img src="assets/images/doc-rtl-1.png" alt="">
	<p>We have prepared an example <a target="_blank" href="../../html/template/index-rtl.html">index-rtl.html</a> page, so that you can use it as a guide. If you face any issues related with RTL version, please report it to <a href="http://htmlcoder.me/support">support</a>.</p>
	<br>
	<br>
	<br>
	<h3>LTR, RTL and SASS</h3>
	<hr>
	<p>The Project template, uses sass mixins smartly (in A1 group, see diagram), in order to create both <strong>left-to-right</strong> and <strong>right-to-left</strong> versions from the same core (styling) sass files.</p>
	<p>In the following diagram you can see the structure and the logic of the sass files inside the template:</p>
	<img src="assets/images/doc-rtl-2.jpg" alt="">
	<p class="info">RTL version is not supported with LESS preprocessor in the Project template, if you are planing to build RTL websites please use SASS preprocessor.</p>
</section>
<section id="typography">
	<div class="page-header"><h3>Typography</h3><hr class="notop"></div>
	<p>In version 1.3 we have separated the typography CSS rules from the style.css file, in order to easily change and/or add new typography schemes to the template.</p>
	<p>In css folder you will find typography schemes files:</p>
	<img src="assets/images/doc-typography-1.png" alt="">
	<ul>
		<li>
			<p><strong>typography-default.css</strong>: Is the default typography scheme of the Project's template. Used font families and CSS rules are the same with the previous versions of the template. <br> <strong>If you are planing to update your site</strong>, in order to keep this font scheme add a reference for this file into the head section of your HTML file.</p>
		</li>
	</ul>
	<img src="assets/images/doc-typography-2.png" alt="">
	<ul>
		<li>
			<p><strong>typography-scheme-2.css</strong>: Is added in version 1.3. Used fonts are Lato for the body and Roboto slab for the headings of the template. <br> In order to use this font scheme add a reference for this file into the head section of your HTML file.</p>
		</li>
	</ul>
	<img src="assets/images/doc-typography-3.png" alt="">
</section>
...
<p>
	More info here <a target="_blank" href="http://themes.themepunch.com/?theme=revolution_jq">http://themes.themepunch.com/?theme=revolution_jq</a>. See the detailed documentation of Slider Revolution plugin <a target="_blank" href="https://www.themepunch.com/revsliderjquery-doc/slider-revolution-jquery-5-x-documentation/">here</a>.</p>
<br>
<br>
...
<section id="contact_form">
	<div class="page-header"><h3>Contact form without Google reCAPTCHA</h3><hr class="notop"></div>
	<p>	In order to setup the contact form WITHOUT reCAPTCHA:</p>
	<ol>
		<li>
			<p>Set your email address inside php/email-sender.php file.<br>
...
$Recipient = 'set_your_email_here@domain.com';
		...
		<li>
			<p>Change the id of contact form in <strong>page-contact.html</strong> or  <strong>page-contact-2.html</strong> or  <strong>page-contact-3.html</strong> from <strong>"contact-form-with-recaptcha"</strong> to <strong>"contact-form"</strong> and delete .g-recaptcha div: </p>
			<img src="assets/images/doc-contact-1.png" alt="">
		</li>
	</ol>
<p class="info">
	<strong>The contact form is functional only on a live server with php support not localy on your pc.</strong></p>
</section>
<section id="contact_form_recaptcha">
	<div class="page-header"><h3>Contact form with Google reCAPTCHA</h3><hr class="notop"></div>
<p>	In order to setup the contact form with Google reCAPTCHA.<br>
<ol>
	<li><p>Get your reCAPTCHA api keys from <a href="https://www.google.com/recaptcha/admin">https://www.google.com/recaptcha/admin</a></p></li>
	<li><p>In php/email-sender-recaptcha.php file set your API keys and your email address:</p>
			<img src="assets/images/doc-contact-2.png" alt="">
	</li>
	<li>
		<p>In <strong>page-contact.html</strong> or  <strong>page-contact-2.html</strong> or  <strong>page-contact-3.html</strong> set your site API key to the "<strong>data-sitekey</strong>" attribute of "<strong>.g-recaptcha</strong>" div:</p>
		<img src="assets/images/doc-contact-3.png" alt="">
	</li>
</ol>
<p>You can find more info about Google reCAPTCHA in the following link <a href="https://developers.google.com/recaptcha/">https://developers.google.com/recaptcha/</a></p>

<p class="info"><strong>The contact form is functional only on a live server with php support not localy on your pc.</strong></p>
</section>
...
<p>In order to setup the Google maps:</p>
<ol>
	<li><p>Get your API key from <a href="https://developers.google.com/maps/documentation/javascript/get-api-key">https://developers.google.com/maps/documentation/javascript/get-api-key</a>.</p></li>
	<li><p>Set your API key inside the HTML file that you are using the google maps:</p>
		<img src="assets/images/doc-map-1.png" alt="">
	</li>
	<li>
		<p>To set the location of your business change the default Latitude, Longitude and Zoom of the Google map, please replace the following values inside js/google.map.config.js file:</p>
		<img src="assets/images/doc-map-2.png" alt="">
	</li>
</ol>
</section>
...
<ul>
	...
	<li>
		Fullpage by <a href="http://www.alvarotrigo.com" target="_blank">Alvaro Trigo</a>&nbsp;-&nbsp;<a href="https://github.com/alvarotrigo/fullPage.js">https://github.com/alvarotrigo/fullPage.js</a> - <a href="https://github.com/alvarotrigo/fullPage.js#license">License</a></li>
	<li>
	...
	<li>
		...
		<li>reCAPTCHA by Google Inc - <a target="_blank" href="https://github.com/google/recaptcha">https://github.com/google/recaptcha</a> - <a target="_blank" href="https://github.com/google/recaptcha/blob/master/LICENSE">License</a></li>
</ul>
</section>
<section id="license">
...
<section id="license-2">
	...
	<p style="font-size:16px;">Thank you very much for purchasing the Project template and for reading this documentation :-)</p>
</section>
	</div>
</body>
</html>